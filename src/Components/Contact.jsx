				...
				<div className="grid max-w-6xl text-white grid-cols-1 px-6 md:pt-10 mx-auto lg:px-8 md:grid-cols-2 md:divide-x">
					...
					<form ref={form} onSubmit={sendEmail} className="flex flex-col  py-6 space-y-6 md:py-0 md:px-6">
						<label className="block">
							...
							<input required name='name' type="text" placeholder="Leroy Jenkins" className="block w-full border-1 border-white outline-none h-[40px] rounded-md shadow-sm  " />
						</label>
						<label className="block">
							<span className="mb-2">Email address</span>
							<input required name='email' type="email" placeholder="leroy@jenkins.com" className="block w-full border-1 border-white outline-none h-[40px] rounded-md shadow-sm  " />
						</label>
						<label className="block">
							<span className="mb-2">Message</span>
							<textarea required rows="3" name='message' className="block w-full border-1 border-white outline-none  rounded-md  "></textarea>
						</label>
